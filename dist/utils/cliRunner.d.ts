...
export declare function deleteRegTokenBackup(accountHomeDir: string): void;
export interface CliRunResult {
    stdout: string;
    stderr: string;
}
export type CliRunPhase = 'waiting_credential_slot' | 'credential_slot_acquired' | 'credential_ready' | 'process_started' | 'process_finished';
 ...
 */
export declare function withCredSwap<T>(accountHomeDir: string, fn: () => Promise<T>, tokenMode?: 'restore' | 'clear' | 'none', onPhase?: (phase: CliRunPhase) => void): Promise<T>;
/**
 ...
 */
export declare const runJimengCommand: (command: string, accountHomeDir?: string, saveBackup?: boolean, timeoutMs?: number, onPhase?: (phase: CliRunPhase) => void, tokenMode?: "restore" | "clear" | "none") => Promise<CliRunResult>;
/**
